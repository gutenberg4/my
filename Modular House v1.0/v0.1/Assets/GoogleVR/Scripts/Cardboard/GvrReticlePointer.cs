...
public class GvrReticlePointer : GvrBasePointer {
  ...
  public void UpdateDiameters() {
   ...
   // daca nu se uita la ceva care poate sa fie actionat nu afiseaza Reticle -> Imersiune++
        if (ReticleInnerAngle == 0) ReticleOuterAngle = 0;
  ...
  protected override void Start() {
    ...
    // schimba culoare Reticle
    MaterialComp.color = Color.green;
